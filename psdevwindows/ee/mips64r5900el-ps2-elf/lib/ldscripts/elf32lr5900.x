...
ENTRY(_start)
SEARCH_DIR("=/d/a/ps2dev/ps2dev/ps2dev/ee/mips64r5900el-ps2-elf/lib"); SEARCH_DIR("=/usr/local/lib"); SEARCH_DIR("=/lib"); SEARCH_DIR("=/usr/lib");
SECTIONS
{
  ...
  . = DATA_SEGMENT_ALIGN (128, CONSTANT (COMMONPAGESIZE));
  /* Exception handling.  */
