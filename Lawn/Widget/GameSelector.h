...
private:
    enum
    {
        ...
        //GameSelector_Zombatar = 111, // Zombatar avatar creator disabled (see GameSelector.cpp)
...
public:
    ...
    //NewLawnButton*             mZombatarButton;             // Zombatar avatar creator disabled (see GameSelector.cpp)
