...
public:
	...
	bool					LoadLazyImageBits(MemoryImage* theImage);
	bool					PurgeLazyImage(MemoryImage* theImage, bool theKeepTexture);
	void					PurgeLazyImages();
	bool					IsHeapUnderPressure();
	int						PurgeLazyImageBits(bool theForce = false);
